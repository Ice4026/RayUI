...
L["点击隐藏Skada"] = "Click to hide Skada"
L["点击显示Skada"] = "Click to show Skada"
...
L["模块"] = "Modules"
  ...
  L["Skada设置"] = "Skada Setting"
  L["|cff7aa6d6Ray|r|cffff0000U|r|cff7aa6d6I|rSkada设置模块."] = "|cff7aa6d6Ray|r|cffff0000U|r|cff7aa6d6I|r Skada Setting Module."
    L["非战斗时隐藏"] = "Hide when not combat"
    L["Skada自动隐藏时间"] = "Skada auto hide time"
    L["设置脱战后多少秒隐藏"] = "Timestamp for Skada auto hide when not in combat"
  L["BUFF"] = "BUFF"
  L["冷却提示"] = "CD reminder"
L["头像"] = "UnitFrame"
